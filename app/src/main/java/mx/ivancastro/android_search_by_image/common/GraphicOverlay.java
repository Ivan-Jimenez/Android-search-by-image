...
public class GraphicOverlay extends View {
    ...
    public abstract static class Graphic {
         ...
         * @return
         */
        public Context getApplicationContext () { return overlay.getContext().getApplicationContext(); }
        ...
        public float translateX (float x) {
            if (overlay.facing == CameraSource.CAMERA_FACING_FRONT) return overlay.getWidth() - scaleX(x);
            else return scaleX(x);
        }

        /**
         * Adjusts the coordinates from the preview's coordinate system to the view coordinate system.
         * @param y
         * @return
         */
    ...
    public GraphicOverlay (Context context, AttributeSet attrs) { super(context, attrs); }
